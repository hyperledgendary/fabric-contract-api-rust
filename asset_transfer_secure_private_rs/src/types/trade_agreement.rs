...
impl DataType for TradeAgreement {
    ...
    fn get_key(&self) -> String {
        TradeAgreement::form_key(&self.id)
    }
    ...
    fn form_key(k: &String) -> String {
        format!("TradeAgreement#{}",k)
    }
}

impl WireBufferFromReturnType<TradeAgreement> for WireBuffer {
    fn from_rt(self: &mut Self, s: TradeAgreement) {
