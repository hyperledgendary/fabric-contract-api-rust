...
docker run -d -t --rm -p 9999:9999 -v ${WORKING_DIR}:/local:ro --name wasmcc.example.com --hostname wasmcc.example.com --env-file ${WORKING_DIR}/chaincode.env --network=wasm_microfab hyperledgendary/fabric-chaincode-wasm
sleep 5
# approve
